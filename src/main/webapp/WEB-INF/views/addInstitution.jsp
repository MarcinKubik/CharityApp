    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Operacje:</h6>
                    <a class="collapse-item" href="/admins/addAdmin">Dodaj administratora</a>
                    <a class="collapse-item" href="/admins/listAdmin">Lista administratorów</a>
                </div>
            </div>
        </li>
                            ...
                            <div class="card-body">
                                <form:form modelAttribute="institution" method="post" action="/institutions/add">
                                    <div>
                                        ...
                                        <div>
                                            <form:textarea path="description" rows="3" placeholder="Opis"/>
